...
namespace IngameScript {
  partial class Program {
    public static class Sprites {
      ...
      public const string Pyramid = "Triangle";
      public const string Square = "SquareSimple";
      public const string Triangle = "RightTriangle";
    }
    ...
    public class ColorScheme {
      ...
      public Color GetColor(string nm) {
        ...
        if(s == "meddark") return MedDark;
        if(s == "medlight") return MedLight;
        return Light;
      }
    }
    ...
    public class ShapeCollection {
      ...
      public void Parse(string data) {
        ...
        foreach(string l in data.Split(SEPLN).Select(l => l.Trim())) {
          ...
          if (l.StartsWith("=")) {
            ...
            _sprites.Add(l.Substring(1), sprts);
          } else {
      ...
      void _throwIf(bool t, int i, string msg) {
        if (t) throw new InvalidOperationException($"Error at line {i}: {msg}");
      }
    ...
    public class Display {
      ...
      public class Frame: IDisposable {
        ...
        public Frame(Display display) {
          ...
          _f.Add(new MySprite(SpriteType.TEXTURE, Sprites.Square, _d._s.TextureSize / 2, _d._s.TextureSize, _d._scheme.Dark));
        }

        public void Dispose() {
          // adds the grid for texture
          _f.Add(new MySprite(SpriteType.TEXTURE, Sprites.Grid, _d._s.TextureSize / 2, _d._s.TextureSize * 2, _d._scheme.Light));
          _f.Dispose();
        }
